...
export const faqCategory: FaqCategories[] = [
    {
        id: "course-content",
...
const Frequently = () => {
    ...
    const currentCataegory = faqCategory.find((cat) => cat.id === activeCategory);
        ...
        <div className='min-h-screen p-4'>
            <div className='max-w-6xl mx-auto'>
                <motion.div
                    ...
                    className='mb-12'
                >
                    <h1 className={cn("text-xl md:text-3xl font-medium text-center md:text-left")}>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                        ...
                        <div className='rounded-2xl p-4 border'>
                            {faqCategory.map((cat, index) => (
                                <button
                                    ...
                                    className={cn("w-full text-left px-4 py-3 flex items-center justify-between gap-4 group",
                                        activeCategory === cat.id ? "bg-gradient-to-r from-orange-500 to-orange-400 rounded-lg"
                                            : "text-muted-foreground hover:text-white"
                                    )}
                                >
                                    <span className={cn("font-medium")}>{cat.name}</span>
                                    <svg
                                        className={cn(
                            ...
                            <div className='flex items-center gap-2'>
                                {faqCategory.map((cat, index) => (
                                    <button
                                        ...
                                        className={cn("rounded-full text-left px-4 text-sm py-2 transition-all duration-300 whitespace-nowrap",
                                            activeCategory === cat.id ? "bg-gradient-to-r from-orange-500 to-orange-400 rounded-full"
                                                : "text-muted-foreground hover:text-white"
                                        )}
                                    >
                                        <span className={cn("font-medium")}>{cat.name}</span>
                    ...
                    >
                        <div className='bg-secondary/50 border rounded-xl md:p-6 p-3'>
                            <AnimatePresence mode='wait'>
                                ...
                                >
                                    <div className='space-y-4'>
                                        {currentCataegory?.faqs.map((faq, index) => (
                                            <motion.div
                                                key={faq.id}
                                                initial={{ opacity: 0, y: 20 }}
                                                animate={{ opacity: 1, y: 0 }}
                                            ...
                                            >
                                                <button
                                                    ...
                                                    className='flex items-center justify-between w-full text-left hover:bg-secondary/80 transition-colors px-3 md:px-6 py-2'
                                                >
                ...
                <div className='mt-10'>
                    <div className='rounded-xl border p-8 flex items-center justify-between gap-6'>
                        <div className='flex items-center gap-4'>
                            ...
                            <div>
                                <h2 className='text-2xl font-bold'>Still Confused?</h2>
                                <p className='text-muted-foreground text-base'>Feel free to post your queries over our WhatsApp Support</p>
                            </div>
                        </div>
                        <GradientButton text="Ask your Query" />
                    </div>
                </div>
            </div>
        </div>
