...
import { TestimonialsColumn } from './ui/testimonals-scrolls';
...
const firstColumn = testimonals.slice(0, 3);
const secondColumn = testimonals.slice(3, 6);
const thirdColumn = testimonals.slice(6, 9);
    ...
    return (
        <section className="my-20 relative">
            ...
            <div className='flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[740px] overflow-hidden'>
                <TestimonialsColumn
                    duration={15} testimonials={firstColumn} />
